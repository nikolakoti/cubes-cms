...
<div class="card mb-3">
	<div class="card-header">
		<i class="fa fa-table"></i> Product Groups list

		<div class="btn-group btn-group-sm float-right">
			<a class="btn btn-secondary" href="{{route('admin.product-groups.add')}}">
						...
						<td class="text-center">
							<div class="btn-group">
								<a 
									...
									href="{{route('admin.product-groups.edit', ['id' => $productGroup->id])}}"
									title="edit"
...
<form method="post" action="{{route('admin.product-groups.delete')}}" class="modal fade" id="delete-record-modal" tabindex="-1" role="dialog" aria-hidden="true">
	{{csrf_field()}}
